...
public class LifecycleMonitorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        // se compara bundle cu null, daca e diferit de null a fost creat
        if (savedInstanceState == null) {
            Log.d(Constants.TAG, "Activity not launched in execution already");
        } else {
            Log.d(Constants.TAG, "Activity already launched in execution");
        }
    ...
    protected void onStart() {
        super.onStart();
        Log.v(Constants.TAG, "onStart method was invoked verbose");
